...
<html>
    ...
    <nav>
        ...
        <ul id="menuGeneral">
            ...
            <li></li>      
            <li><a href="./?action=creeSalle"><img src="images/plus232.png" alt="imgCreeSalle+" /> Crée Salle</a></li>
              
            <li id="logo"><a href="./?action=accueil"><img src="images/logoM2l-red60.jpg" alt="logoM2l" /></a></li>

            <li><a href="./?action=modifierSalle"><img src="images/modifier232.png" alt="imgModifierSalle" /> Modifier Salle</a></li>
